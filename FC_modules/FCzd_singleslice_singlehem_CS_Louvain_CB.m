...
for gamidx=1:NG,
    ...
    for fidx=1:length(Nfvec),
        CB(:,:,gamidx,fidx)=clustersol_representation(Sb(:,fidx));  
    end
...
Sb=squeeze(mean(CB,4));
Sb=squeeze(mean(Sb,3));

save(['C:\Users\willian1\OneDrive - Aalto University\Previous_projects\Nitin\HBPconnectome\GA_data\submission\mSb_Louvain_pct80_CB_lefthem_wFC_67subs_parc2k9_acrossgvals_acrossfreqs.mat'],'Sb');
