...
save(['C:\Users\willian1\OneDrive - Aalto University\Previous_projects\Nitin\HBPconnectome\GA_data\submission\Sb_gamma' num2str(gamma) '_pctval' int2str(pctval) '_thr' int2str(nct) '_67subs_lefthem_wTFC_parc2k9.mat'],'Sb');
