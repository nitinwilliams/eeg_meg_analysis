...
load(['Sb_weighted_SC_MEG_FC_parc2k9_mlcd_gamma' num2str(gamma) '_optomegavals.mat'],'S3');
Sf=[S3(:,1);S3(:,2)];

load(['B:\Nitin\SCFC_methods\data\meg_data\Sb_weighted_FC_MEG_surr_gamma' num2str(gamma) '_pctval0_thr0_lefthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
Sb_surr_LH_FC=Sb; Zmat_surr_LH_FC=Zmat;
load(['B:\Nitin\SCFC_methods\data\meg_data\Sb_weighted_FC_MEG_surr_gamma' num2str(gamma) '_pctval0_thr0_righthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
...
save(['B:\Nitin\SCFC_methods\data\sc_meg_data\Pstabmat_weighted_Louvain_SC_FC_MEG_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '_pct' int2str(pctval) '.mat'],'Pstabmat','Pstabmat_rand','Sb_surr');
