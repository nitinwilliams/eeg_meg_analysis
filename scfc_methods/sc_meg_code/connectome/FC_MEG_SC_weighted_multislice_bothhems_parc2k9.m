...
load(['B:\Nitin\SCFC_methods\data\meg_data\Sb_weighted_FC_MEG_gamma' num2str(gamma) '_pctval0_thr0_lefthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
LH=Sb;
A1{1}=Zmat{1,1};

load(['B:\Nitin\SCFC_methods\data\meg_data\Sb_weighted_FC_MEG_gamma' num2str(gamma) '_pctval0_thr0_righthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
RH=Sb;
A1{2}=Zmat{1,1};
...
save(['B:\Nitin\SCFC_methods\data\sc_meg_data\Sb_weighted_SC_MEG_FC_parc2k9_mlcd_gamma' num2str(gamma) '_optomegavals.mat'],'S3','A3','omega_vals');
