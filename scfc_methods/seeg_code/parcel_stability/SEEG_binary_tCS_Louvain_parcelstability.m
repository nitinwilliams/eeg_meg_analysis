...
load(['Sb_binary_gamma' num2str(gamma) '_pctval' int2str(pctval) '_thr0_' Nf{1,1} 'Hz_righthem_wTFC_parc2k9.mat'],'Sb');
Sf=Sb;

load(['Sb_binary_surr_gamma' num2str(gamma) '_pctval' int2str(pctval) '_thr' int2str(nct) '_' Nf{1,1} 'Hz_righthem_wTFC_parc2k9.mat'],'Sb');
Sb_surr=Sb;
...
save(['B:\Nitin\SCFC_methods\data\seeg_data\Pstabmat_binary_Louvain_SEEG_FC_' Nf{1,1} 'Hz_righthem_parc2k9_67subs_gamma' num2str(gamma) '_pct' int2str(pctval) '.mat'],'Pstabmat','Pstabmat_rand');
