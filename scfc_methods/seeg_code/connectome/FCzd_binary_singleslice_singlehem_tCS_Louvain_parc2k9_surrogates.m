...
save(['B:\Nitin\SCFC_methods\data\seeg_data\Sb_binary_surr_gamma' num2str(gamma) '_pctval' int2str(pctval) '_thr' int2str(nct) '_' Nf{1,1} 'Hz_righthem_wTFC_parc2k9.mat'],'Sb','Zmat');
