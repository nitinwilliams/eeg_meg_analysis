...
load(['B:\Nitin\SCFC_methods\data\seeg_data\Sb_weighted_surr_gamma' num2str(gamma) '_pctval' int2str(pctval1) '_thr' int2str(nct) '_' Nf{1,1} 'Hz_lefthem_wTFC_parc2k9.mat'],'Sb');
Sb_surr_SEEG=Sb;

load(['B:\Nitin\SCFC_methods\data\seeg_data\Pstabmat_weighted_Louvain_SEEG_FC_' Nf{1,1} 'Hz_lefthem_parc2k9_67subs_gamma' num2str(gamma) '_pct' int2str(pctval1) '.mat'],'Pstabmat','Pstabmat_rand');  
...
load(['B:\Nitin\SCFC_methods\data\seeg_data\Sb_weighted_surr_gamma' num2str(gamma) '_pctval' int2str(pctval1) '_thr' int2str(nct) '_' Nf{1,1} 'Hz_righthem_wTFC_parc2k9.mat'],'Sb');
Sb_surr_SEEG=Sb;

load(['B:\Nitin\SCFC_methods\data\seeg_data\Pstabmat_weighted_Louvain_SEEG_FC_' Nf{1,1} 'Hz_righthem_parc2k9_67subs_gamma' num2str(gamma) '_pct' int2str(pctval1) '.mat'],'Pstabmat','Pstabmat_rand');  
Pstabmat_thr=squeeze(prctile(Pstabmat_rand,95,2));
MASK_SEEG=Pstabmat>Pstabmat_thr;
...
save(['B:\Nitin\SCFC_methods\data\seeg_data\partsim_weighted_Louvain_SC_SEEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '.mat'],'PS_lefthem','PS_righthem','PS_bothhems');
save(['B:\Nitin\SCFC_methods\data\seeg_data\zpartsim_weighted_Louvain_SC_SEEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '.mat'],'zPS_lefthem','zPS_righthem','zPS_bothhems');
