...
load(['Sb_weighted_FC_MEG_gamma' num2str(gamma) '_pctval' int2str(pctval) '_thr0_righthem_wTFC_parc2k9.mat'],'Sb');
Sf=Sb;

load(['Sb_weighted_FC_MEG_surr_gamma' num2str(gamma) '_pctval' int2str(pctval) '_thr0_righthem_wTFC_parc2k9.mat'],'Sb');
Sb_surr=Sb;
...
save(['B:\Nitin\SCFC_methods\data\meg_data\Pstabmat_weighted_Louvain_FC_MEG_righthem_parc2k9_67subs_gamma' num2str(gamma) '_pct' int2str(pctval) '.mat'],'Pstabmat','Pstabmat_rand');
