...
load(['B:\Nitin\SCFC_methods\data\meg_data\Sb_binary_FC_MEG_surr_gamma' num2str(gamma) '_pctval' int2str(pctval1) '_thr' int2str(nct) '_lefthem_wTFC_parc2k9.mat'],'Sb');
Sb_surr_MEG=Sb;

load(['B:\Nitin\SCFC_methods\data\meg_data\Pstabmat_binary_Louvain_FC_MEG_lefthem_parc2k9_67subs_gamma' num2str(gamma) '_pct' int2str(pctval1) '.mat'],'Pstabmat','Pstabmat_rand');  
...
load(['B:\Nitin\SCFC_methods\data\meg_data\Sb_binary_FC_MEG_surr_gamma' num2str(gamma) '_pctval' int2str(pctval1) '_thr' int2str(nct) '_righthem_wTFC_parc2k9.mat'],'Sb');
Sb_surr_MEG=Sb;

load(['B:\Nitin\SCFC_methods\data\meg_data\Pstabmat_binary_Louvain_FC_MEG_righthem_parc2k9_67subs_gamma' num2str(gamma) '_pct' int2str(pctval1) '.mat'],'Pstabmat','Pstabmat_rand');  
Pstabmat_thr=squeeze(prctile(Pstabmat_rand,95,2));
MASK_MEG=Pstabmat>Pstabmat_thr;
...
save(['B:\Nitin\SCFC_methods\data\meg_data\partsim_binary_Louvain_SC_MEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '.mat'],'PS_lefthem','PS_righthem','PS_bothhems');
save(['B:\Nitin\SCFC_methods\data\meg_data\zpartsim_binary_Louvain_SC_MEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '.mat'],'zPS_lefthem','zPS_righthem','zPS_bothhems');
