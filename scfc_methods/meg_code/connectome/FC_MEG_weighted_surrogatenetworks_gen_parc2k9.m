...
fname=strcat('PLVmats_9.83Hz_19_PARC2k9_148parcs_wsubmat.mat');
load(fname,'PLVmats_submats');

reps=100;
num_subs=size(PLVmats_submats,3);

PLVmats_groupmat=zeros(N*2,N*2,reps);

for repidx=1:reps,

    sub_idxs=randi(num_subs,[num_subs,1]);
    D=squeeze(mean(PLVmats_submats(:,:,sub_idxs),3));
    PLVmats_groupmat(:,:,repidx)=D;
    
end
       
save(['B:\Nitin\SCFC_methods\data\meg_data\PLVmats_surrmats_9.83Hz_19_PARC2k9_148parcs_wgroupmat.mat'],'PLVmats_groupmat');
