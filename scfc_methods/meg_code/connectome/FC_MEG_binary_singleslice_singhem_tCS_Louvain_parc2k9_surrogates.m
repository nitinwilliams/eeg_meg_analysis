...
save(['B:\Nitin\SCFC_methods\data\meg_data\Sb_binary_FC_MEG_surr_gamma' num2str(gamma) '_pctval' int2str(pctval) '_thr' int2str(nct) '_righthem_wTFC_parc2k9.mat'],'Sb','Zmat');
