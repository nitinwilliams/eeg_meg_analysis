...
load(['Sb_binary_SC_SEEG_FC_parc2k9_mlcd_gamma' num2str(gamma) '_optomegavals.mat'],'S3');
Sf=[S3(:,1);S3(:,2)];

load(['B:\Nitin\SCFC_methods\data\seeg_data\Sb_binary_surr_gamma' num2str(gamma) '_pctval80_thr0_' Nf{1,1} 'Hz_lefthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
Sb_surr_LH_FC=Sb; Zmat_surr_LH_FC=Zmat;
load(['B:\Nitin\SCFC_methods\data\seeg_data\Sb_binary_surr_gamma' num2str(gamma) '_pctval80_thr0_' Nf{1,1} 'Hz_righthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
Sb_surr_RH_FC=Sb; Zmat_surr_RH_FC=Zmat;

load(['B:\Nitin\SCFC_methods\data\sc_data\Sb_binary_SC_surr_gamma' num2str(gamma) '_pctval80_thr0_lefthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
Sb_surr_LH_SC=Sb; Zmat_surr_LH_SC=Zmat;
load(['B:\Nitin\SCFC_methods\data\sc_data\Sb_binary_SC_surr_gamma' num2str(gamma) '_pctval80_thr0_righthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
...
save(['B:\Nitin\SCFC_methods\data\sc_seeg_data\Pstabmat_binary_Louvain_SC_SEEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '_pct' int2str(pctval) '.mat'],'Pstabmat','Pstabmat_rand','Sb_surr');
