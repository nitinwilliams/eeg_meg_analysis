...
numparcs=74;
seeg_lefthem_idxs=[1:1*numparcs];
seeg_righthem_idxs=[1*numparcs+1:2*numparcs];
...
load(['B:\Nitin\SCFC_methods\data\sc_seeg_data\Pstabmat_weighted_Louvain_SC_SEEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '_pct' int2str(pctval) '.mat'],'Pstabmat','Pstabmat_rand','Sb_surr');  

%% Left hemisphere

Sb_surr_SEEG=Sb_surr(seeg_lefthem_idxs,:);
Pstabmat_thr=squeeze(prctile(Pstabmat_rand,95,2));

MASK_SEEG=Pstabmat(seeg_lefthem_idxs,:)>Pstabmat_thr(seeg_lefthem_idxs,:);
...
Sb_surr_SEEG=Sb_surr(seeg_righthem_idxs,:);
Pstabmat_thr=squeeze(prctile(Pstabmat_rand,95,2));

MASK_SEEG=Pstabmat(seeg_righthem_idxs,:)>Pstabmat_thr(seeg_righthem_idxs,:);
...
save(['B:\Nitin\SCFC_methods\data\sc_seeg_data\partsim_weighted_GenLouvain_SC_SEEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '.mat'],'PS_lefthem','PS_righthem','PS_bothhems');
save(['B:\Nitin\SCFC_methods\data\sc_seeg_data\zpartsim_weighted_GenLouvain_SC_SEEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '.mat'],'zPS_lefthem','zPS_righthem','zPS_bothhems');
