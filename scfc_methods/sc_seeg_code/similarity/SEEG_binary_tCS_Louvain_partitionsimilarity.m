...
load(['B:\Nitin\SCFC_methods\data\sc_seeg_data\Pstabmat_binary_Louvain_SC_SEEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '_pct' int2str(pctval) '.mat'],'Pstabmat','Pstabmat_rand','Sb_surr');  
...
save(['B:\Nitin\SCFC_methods\data\sc_seeg_data\partsim_binary_GenLouvain_SC_SEEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '.mat'],'PS_lefthem','PS_righthem','PS_bothhems');
save(['B:\Nitin\SCFC_methods\data\sc_seeg_data\zpartsim_binary_GenLouvain_SC_SEEG_FC_' Nf{1,1} 'Hz_parc2k9_67subs_gamma' num2str(gamma) '.mat'],'zPS_lefthem','zPS_righthem','zPS_bothhems');
