...
load(['B:\Nitin\SCFC_methods\data\seeg_data\Sb_weighted_gamma' num2str(gamma) '_pctval80_thr0_' Nfvec{1,1} 'Hz_lefthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
LH=Sb;
A1{1}=Zmat{1,1};

load(['B:\Nitin\SCFC_methods\data\seeg_data\Sb_weighted_gamma' num2str(gamma) '_pctval80_thr0_' Nfvec{1,1} 'Hz_righthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
RH=Sb;
A1{2}=Zmat{1,1};
...
load(['B:\Nitin\SCFC_methods\data\sc_data\Sb_weighted_SC_gamma' num2str(gamma) '_pctval0_thr0_lefthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
LH=Sb;
A2{1}=Zmat{1,1};

load(['B:\Nitin\SCFC_methods\data\sc_data\Sb_weighted_SC_gamma' num2str(gamma) '_pctval0_thr0_righthem_wTFC_parc2k9.mat'],'Sb','Zmat'); 
RH=Sb;
A2{2}=Zmat{1,1};
...
save(['B:\Nitin\SCFC_methods\data\sc_seeg_data\Sb_weighted_SC_SEEG_FC_parc2k9_mlcd_gamma' num2str(gamma) '_optomegavals.mat'],'S3','A3','omega_vals');
