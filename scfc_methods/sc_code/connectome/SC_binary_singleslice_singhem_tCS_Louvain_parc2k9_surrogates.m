...
save(['B:\Nitin\SCFC_methods\data\sc_data\Sb_binary_SC_surr_gamma' num2str(gamma) '_pctval' int2str(pctval) '_thr' int2str(nct) '_righthem_wTFC_parc2k9.mat'],'Sb','Zmat');
