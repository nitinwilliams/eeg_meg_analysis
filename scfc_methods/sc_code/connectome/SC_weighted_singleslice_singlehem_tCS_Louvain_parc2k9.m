...
load(fname,'avg_sc');
D=avg_sc(righthem_idxs,righthem_idxs);
D=D+D';
...
save(['B:\Nitin\SCFC_methods\data\sc_data\Sb_weighted_SC_gamma' num2str(gamma) '_pctval' int2str(pctval) '_thr' int2str(nct) '_righthem_wTFC_parc2k9.mat'],'Sb','Zmat');
