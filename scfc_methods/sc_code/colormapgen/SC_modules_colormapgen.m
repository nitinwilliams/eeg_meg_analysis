...
load(['B:\Nitin\SCFC_methods\data\sc_data\Sb_binary_SC_gamma2_pctval80_thr0_lefthem_wTFC_parc2k9.mat']);
...
load(['B:\Nitin\SCFC_methods\data\sc_data\Pstabmat_binary_Louvain_SC_lefthem_parc2k9_67subs_gamma2_pct80.mat'],'Pstabmat','Pstabmat_rand'); 

Pstabmat=mean(Pstabmat,2);
Pstabmat_rand=squeeze(mean(Pstabmat_rand,3));
...
load(['B:\Nitin\SCFC_methods\data\sc_data\Sb_binary_SC_gamma2_pctval80_thr0_righthem_wTFC_parc2k9.mat']);
...
load(['B:\Nitin\SCFC_methods\data\sc_data\Pstabmat_binary_Louvain_SC_righthem_parc2k9_67subs_gamma2_pct80.mat'],'Pstabmat','Pstabmat_rand'); 
...
save(['RGBcolormap_binary_Louvain_SC_modules_gamma2_parc2k9.mat'],'M_scaled');
