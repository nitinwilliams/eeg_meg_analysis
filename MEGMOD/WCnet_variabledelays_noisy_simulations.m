function WCnet_variabledelays_noisy_simulations(array_idx,run_idx)
%% Initialisation
...
global PY2LV_transvec avg_sc WCnet_noisy_variabledelays_paramcombinations source2parc fwd_mat inv_mat
toc;
...
num_reps=5;
mod_params=WCnet_noisy_variabledelays_paramcombinations(((array_idx-1)*num_reps)+1:(array_idx*num_reps),:);
...
for rep_idx=1:num_reps
        ...
        Tij=ceil((DISTMAT/mod_params(rep_idx,12)));
    ...
    save(['/scratch/work/willian1/MEGMOD/MATLAB/data/WCnet_variabledelays_noisy_60s_simulations_batch',int2str(array_idx),'_run',int2str(run_idx),'.mat'],...
    'wPLImags_acrossreps','PLVmags_acrossreps','mod_params');
