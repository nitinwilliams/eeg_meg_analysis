function WCnet_mixeddelays_noisy_posteriorpredictivechecks(array_idx)
%% Initialisation
...
global PY2LV_transvec WCnet_noisy_mixeddelays_posteriordistribution avg_sc source2parc fwd_mat inv_mat
toc;
...
num_reps=5;
mod_params=WCnet_noisy_mixeddelays_posteriordistribution(((array_idx-1)*num_reps)+1:(array_idx*num_reps),:);
...
for rep_idx=1:num_reps
      ...
      save(['/scratch/work/willian1/MEGMOD/MATLAB/data/WCnet_mixeddelays_noisy_60s_posteriorpredictivechecks_batch',int2str(array_idx),'.mat'],...
